...
Umgebung ist weit entfernt, nur die Richtung $r$ wird verwendet,  Ausgangspunkt $P$ wird ignoriert.
...
Speicherplatz der Daten\-struktur ist abhängig von der Anzahl der Primive & Ja            & Ja                   & Ja                    & (Ja) (je nachdem wie gespeichert wird)                  \\
...
\begin{enumerate}
    \item Lösche Tiefenpuffer (1.)
    \item Zeichne Wände (3.)
    \item Zeichne Fenster (2.)
\end{enumerate}
...
\begin{table}[H]
    ...
    ZeichneWände   & X  & -  & -  & Tiefentest ist für Sichtbarkeit zuständig      \\
    ZeichneFenster & -  & -  & X  & Blending ist i.A. nicht kommutativ       \\\bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    ZeichneWände   & X       & -  & X & -    & X & -    \\
    ZeichneFenster & X       & -  & X & -    & - & X   \\\bottomrule
    \end{tabular}
\end{table}
