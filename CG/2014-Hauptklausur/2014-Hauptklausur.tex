...
\mint{cpp}{glBlendFunc(GL_SRC_ALPHA /*(2)*/, GL_ONE_MINUS_SRC_ALPHA /*(3)*/)}

\subsection*{Teilaufgabe 9b}
\mint{cpp}{glBlendFunc(GL_ONE /*(1)*/, GL_ONE /*(1)*/)}

\subsection*{Teilaufgabe 9c}
\mint{cpp}{glBlendFunc(GL_ZERO /*(0)*/, GL_ONE_MINUS_SRC_COLOR /*(7)*/)}
